...
function ActivityAccessory(accessory, log, connection, platformConfig) {
...
ActivityAccessory.prototype.initAsync = function() {
        ...
        if (!this.platformConfig || !this.platformConfig.disableVolumeControl) {
                if (volSvc) {
                ...
                this.accessory.removeService(volSvc);
        }
...
var ActivityVolumeService = function(activityAccessory) {
        VolumeService.call(this, activityAccessory.accessory.displayName + " Sound", null, activityAccessory.log);
        var self = this;
